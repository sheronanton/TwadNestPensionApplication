...
<%
 ...
 try {
   ...
   Color backgroundColor = Color.decode("#2b94c1");//#2b94c1
   
   
   Color borderColor = Color.decode("#2b94c1");  
   Color textColor = Color.decode("#ffb60f");  
   Color circleColor = new Color(160,160,160);
   Font textFont = new Font("Century Schoolbook L", Font.CENTER_BASELINE, paramInt(request, "fontSize", 45));
   int charsToPrint = 6;
   int width = paramInt(request, "width", 175);
