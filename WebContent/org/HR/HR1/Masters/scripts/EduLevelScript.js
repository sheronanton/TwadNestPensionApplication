function getTransport()
{
 ...
 function callServer(command,param)
 {
       ...
       if(command=="Add")
        {              
                    if(document.EduForm.txtQualDesc.value=="")
                    {
                       alert("Please Enter the Qualification Level Description");
                    }
                    else
                    {
                    url="../../../../../EduLevel_Servlet.view?command=Add&QualDesc=" + strQualDesc;
        ...
        else if(command=="Update")
        {
                    ...
                    {
                    url="../../../../../EduLevel_Servlet.view?command=Update&QualId="+hstrQualId+"&QualDesc="+strQualDesc;
                   var req=getTransport();
                   req.open("GET",url,true); 
            req.onreadystatechange=function()
            {
        ...
        if(confirm("Do You Really want to Delete the Selected Record"))
             {
                    url="../../../../../EduLevel_Servlet.view?command=Delete&QualId="+hstrQualId;
                    var req=getTransport();
                    req.open("GET",url,true); 
            req.onreadystatechange=function()
            {
  ...
  function addRow(baseResponse)
    {
              ...
              {                        
                     ...
                     qid=baseResponse.getElementsByTagName("QualId")[0].firstChild.nodeValue; 
                      alert("Please Note Down Your Educational Qualification Level Id " +  qid);
                     var items=new Array();                   
