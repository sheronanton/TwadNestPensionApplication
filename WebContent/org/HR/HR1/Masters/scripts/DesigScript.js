    ...
    {      
        ...
        // alert(rcells.item(1).firstChild.nodeValue);
         ...
         // document.DesigForm.cmbPayId.value=rcells.item(4).firstChild.nodeValue;
          document.DesigForm.cmbSerId.value=rcells.item(4).firstChild.value;
           document.DesigForm.txtDesigsDesc.value=rcells.item(5).firstChild.nodeValue;
          document.DesigForm.txtRemarks.value=rcells.item(6).firstChild.nodeValue;
 ...
 function callServer(command,param)
 {
       ...
       if(command=="Add")
        {           /* flag=nullCheck();  
                    if(flag==true)
                    {*/
                    url="../../../../../Designation_Servlet.view?command=Add&DesigDesc=" + strDesigDesc+"&DesigsDesc="+strDesigsDesc+"&CadreId="+strCadreId+"&SerId="+strSerId+"&Remarks="+strRemarks;
        ...
        else if(command=="Update")
        {
                    ...
                    if(flag==true)
                    {*/
                    url="../../../../../Designation_Servlet.view?command=Update&DesigId="+hstrDesigId+"&DesigDesc="+strDesigDesc+"&DesigsDesc="+strDesigsDesc+"&CadreId="+strCadreId+"&SerId="+strSerId+"&Remarks="+strRemarks;
                   var req=getTransport();
            req.open("GET",url,true); 
            req.onreadystatechange=function()
            {
          ...
          if(confirm("Do You Really want to Delete the Selected Record"))
             {
                    ...
                    url="../../../../../Designation_Servlet.view?command=Delete&DesigId="+hstrDesigId;
                   var req=getTransport();
            req.open("GET",url,true); 
            req.onreadystatechange=function()
            {
        ...
        {               
                          url="../../../../../Designation_Servlet.view?command=Get";
                         var req=getTransport();
            req.open("GET",url,true); 
            req.onreadystatechange=function()
            {
        ...
        {               
                          url="../../../../../Designation_Servlet.view?command=Pay&CadreId="+strCadreId;
                         var req=getTransport();
            req.open("GET",url,true); 
            req.onreadystatechange=function()
            {
              ...
              {                        
                   ...
                   var servname=document.DesigForm.cmbSerId.options[document.DesigForm.cmbSerId.selectedIndex].text;
                    ...
                    /*  var Paycell=document.createElement("TD");  
                     ...
                     sid.text=servid;
                     sid.value=servid;
                     cell5.appendChild(sid);
                     cell5.appendChild(sname);
