...
function penListSearchph(command)
{
...
if(!srctxt1.value.match(alphaExp))
{
	...
	{		
	    ...
	    if(command=="Search")
		  {
   		   var url="../pensionerListSearchPh.html?penListph.penListSearchKeyword="+penListSearchKeyword+
   		   "&penListph.penListSearchOptions="+penListSearchOptions;
