...
function penDetailSearch(command)
{
...
if(!srctxt1.value.match(alphaExp))
{
	...
	{		
	    ...
	    if(command=="Search")
		  {
	    	var url="../pensionerDetailSearch.html?valpenrept.reportSearchKeyword="+reportSearchKeyword+
   		   "&valpenrept.reportSearchOptions="+reportSearchOptions;
