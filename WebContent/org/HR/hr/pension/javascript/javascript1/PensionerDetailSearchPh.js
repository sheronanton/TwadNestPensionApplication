...
function penDetailSearchPh(command)
{
...
if(!srctxt1.value.match(alphaExp))
{
	...
	alert('Please Enter Alphabets Only');
		...
		{
		penDetailSearch1(command);		
		}
}
	
	function penDetailSearch1(command)
	{		
	    ...
	    if(command=="Search")
		  {
	    	var url="../pensionerDetailSearchPh.html?valpenreptph.reportSearchKeyword="+reportSearchKeyword+
   		   "&valpenreptph.reportSearchOptions="+reportSearchOptions;
