...
var __pagination=5;
//********************  Year Constant Range *****************************
var _Service_Period_Beg_Year=1940;
...
function killChars(Word)
{
 
	 strWord=Word.value;
	 strWord = strWord.replace(/[^a-zA-Z 0-9]+/g,'');
	 Word.value = strWord;
