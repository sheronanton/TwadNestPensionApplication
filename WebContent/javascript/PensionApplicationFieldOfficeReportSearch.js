...
function penAppFeildOfficeReportSearch(command)
{
	...
	else{penAppFeildOfficeReportSearch1(command);}
	}
	...
	{
		penAppFeildOfficeReportSearch1(command);
	}	
}
...
function penAppFeildOfficeReportSearch1(command)
{
    ...
    if(command=="Search")
      ...
      var url="PenAppFieldOfficeReportSearch.html?penappfieldofficereport.penappreportSearchKeyword="+penappreportSearchKeyword+"&penappfieldofficereport.penappreportSearchOptions="+penappreportSearchOptions;
  ...
  if(req.readyState==4)
  {
     if(req.status==200)
      {  
       ...
       if(command=="PenAppFieldOfficeReportUserSearch")
        {         	
