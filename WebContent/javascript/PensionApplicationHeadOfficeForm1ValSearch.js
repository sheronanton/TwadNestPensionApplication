...
function penAppHeadOfficeForm1Search1(command)
{
    ...
    if(command=="Search")
      ...
      var url="PensionApplicationHOForm1ValSearch.html?penAppHeadOfficeform1ValSrch.SearchScreenKeyword="+SearchScreenKeyword+"&penAppHeadOfficeform1ValSrch.SearchScreenOptions="+SearchScreenOptions;
  ...
  if(req.readyState==4)
  {
     if(req.status==200)
      {  
       ...
       if(command=="PenAppHeadOfficeForm1ValSearch")
        {         	
