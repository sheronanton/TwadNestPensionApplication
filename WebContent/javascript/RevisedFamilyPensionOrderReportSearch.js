...
function RevFamPenOrderReportSearch(command)
{
	...
	else{RevFamPenOrderReportSearch1(command);}
	}
	...
	{
		RevFamPenOrderReportSearch1(command);
	}	
}



function RevFamPenOrderReportSearch1(command)
{
    ...
    if(command=="Search")
      ...
      var url="RevFamPenOrderReportSearch1.html?revFamPenorderReport.penappreportSearchKeyword="+penappreportSearchKeyword+"&revFamPenorderReport.penappreportSearchOptions="+penappreportSearchOptions;
  ...
  if(req.readyState==4)
  {
     if(req.status==200)
      {  
       ...
       if(command=="FamPenOrderReportUserSearch1")
        {         	
