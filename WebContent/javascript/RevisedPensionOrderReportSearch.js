...
function RevPenOrderReportSearch(command)
{
	...
	else{RevPenOrderReportSearch1(command);}
	}
	...
	{
		RevPenOrderReportSearch1(command);
	}	
}



function RevPenOrderReportSearch1(command)
{
    ...
    if(command=="Search")
      ...
      var url="RevPenOrderReportSearch1.html?revPenorderReport.penappreportSearchKeyword="+penappreportSearchKeyword+"&revPenorderReport.penappreportSearchOptions="+penappreportSearchOptions;
  ...
  if(req.readyState==4)
  {
     if(req.status==200)
      {  
       ...
       if(command=="PenOrderReportUserSearch1")
        {         	
