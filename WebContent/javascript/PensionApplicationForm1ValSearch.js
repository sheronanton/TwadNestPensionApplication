...
function penAppForm1Search1(command)
{
    ...
    if(command=="Search")
      ...
      var url="PensionApplicationForm1ValSearch.html?penAppform1ValSrch.SearchScreenKeyword="+SearchScreenKeyword+"&penAppform1ValSrch.SearchScreenOptions="+SearchScreenOptions;
  ...
  if(req.readyState==4)
  {
     if(req.status==200)
      {  
       ...
       if(command=="PenAppForm1ValSearch")
        {         	
