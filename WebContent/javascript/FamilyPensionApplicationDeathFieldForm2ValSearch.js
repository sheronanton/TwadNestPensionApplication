...
{		
	...
	var searchKeyword=document.getElementById("SearchKeyword").value;
		...
		if(command=="ValidateSearch")
			{
			var url="famPenAppFieldForm2ValidateSearch.html?fpenappf2.searchOption="+searchOptions+"&fpenappf2.searchKeyword="+searchKeyword;
		...
		if(command=="EditSearch")
			{
			var url="famPenAppFieldForm2EditSearch.html?fpenappeditf2.searchOption="+searchOptions+"&fpenappeditf2.searchKeyword="+searchKeyword;
			var req=getTransport1();
			req.open("GET",url,true);          
				req.onreadystatechange=function()
				{
           ...
           if(len>0)            	  
            {
        	  ...
        	  for(var i=0;i<display.length;i++)
                ...
                record3[i] = nullcheck(baseResponse.getElementsByTagName("claimName")[i].firstChild.nodeValue);
...
function loadRecordVal(page)
{
    ...
    for(i=p;i<record1.length && c<__pagination;i++)
    {
            ...
            cell2.setAttribute("id", "claimName"+sno);
