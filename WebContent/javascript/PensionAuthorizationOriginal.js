...
function setRadio()
{
	...
	document.getElementById("saveStatusDraft").checked=true;
}
	  ...
	  if(display.length <=0)
	  {
	   ...
	   {		  
    	  ...
    	  {    
			  ...
			  if(baseResponse.getElementsByTagName("residentAddress")[i].firstChild!=null){
			  ...
			  if(baseResponse.getElementsByTagName("fromAddress")[i].firstChild!=null){
			  document.getElementById("fromAddress").value=nullcheck(baseResponse.getElementsByTagName("fromAddress")[i].firstChild.nodeValue);
			  }else{
			  ...
			  document.getElementById("lastWorkingOfficeId").value=nullcheck(baseResponse.getElementsByTagName("lastOfficeId")[i].firstChild.nodeValue);
			   ...
			   if(baseResponse.getElementsByTagName("lastOfficeAddress")[i].firstChild!=null){
					 document.getElementById("lastWorkOfficeAddress").value=nullcheck(baseResponse.getElementsByTagName("lastOfficeAddress")[i].firstChild.nodeValue);
			 	}else{
					 document.getElementById("lastWorkOfficeAddress").value="";
				 }
			 
			 if(baseResponse.getElementsByTagName("lastOffice")[i].firstChild!=null){
			 ...
			 if(baseResponse.getElementsByTagName("payOfficeAddress")[i].firstChild!=null){
			  document.getElementById("paymentOfficeAddress").value=nullcheck(baseResponse.getElementsByTagName("payOfficeAddress")[i].firstChild.nodeValue);
			    ...
			    if(baseResponse.getElementsByTagName("letterNo")[i].firstChild!=null){
			  document.getElementById("letterNo").value=nullcheck(baseResponse.getElementsByTagName("letterNo")[i].firstChild.nodeValue);
			  }else{
			  ...
			  document.getElementById("datedOn").value=nullcheck(baseResponse.getElementsByTagName("datedOn")[i].firstChild.nodeValue);
			   ...
			   if(baseResponse.getElementsByTagName("ref")[i].firstChild!=null){
			  		document.getElementById("reference").value=nullcheck(baseResponse.getElementsByTagName("ref")[i].firstChild.nodeValue);
			  }else{
			  ...
			  if(baseResponse.getElementsByTagName("authOfficerAddress")[i] == undefined){
				  document.getElementById("authOfficeAddress").value = "";
			  }else{
				   document.getElementById("authOfficeAddress").value=baseResponse.getElementsByTagName("authOfficerAddress")[i].firstChild.nodeValue;
			  }
			 ...
			 if(baseResponse.getElementsByTagName("nominId")[i] == null){
				 document.getElementById("nomineeId").value = "";
			 }else{
				 document.getElementById("nomineeId").value = baseResponse.getElementsByTagName("nominId")[i].firstChild.nodeValue;
			 }
			 
			 
			 
			 if(baseResponse.getElementsByTagName("nominName")[i].firstChild == null)
			 {
			...
			if(baseResponse.getElementsByTagName("relDesc")[i].firstChild!=null){
			 ...
			 if(baseResponse.getElementsByTagName("relDesc")[i].firstChild!=null){
			  ...
			  if(baseResponse.getElementsByTagName("nameFromAddress")[i].firstChild!=null){
			  ...
			  if(baseResponse.getElementsByTagName("serviceBookAddress")[i].firstChild!=null){
			  ...
			  if(baseResponse.getElementsByTagName("residentAddress")[i].firstChild!=null){
			  if(nullcheck(baseResponse.getElementsByTagName("residentAddress")[i].firstChild.nodeValue)=="")
			  {
				  document.getElementById("empAddress").value=nullcheck(baseResponse.getElementsByTagName("oldPermanentAddress")[i].firstChild.nodeValue);
			  }
			  }
