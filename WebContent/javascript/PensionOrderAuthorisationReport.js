		...
		try
	  	{
			...
			{
				//alert("u r entering into GenReport() Method");
				  var pensionType=document.getElementById("pensionType").value;				  
				  if(typeOfReportVal==1)
				  {
					  actionurl="pensionOrder1.html?empId="+empno;
					  window.open(actionurl,'mywindow','scrollbars=yes,fullscreen=yes,location=no,menubar=yes');
				  }
				  if(typeOfReportVal==2)
				  {
					  actionurl="pensionOrder2.html?empId="+empno;
					  window.open(actionurl,'mywindow','scrollbars=yes,fullscreen=yes,location=no,menubar=yes');
				  }	
				  if(typeOfReportVal==3)
				  {
					 // alert(typeOfReportVal);
					  actionurl="pensionOrder3.html?empId="+empno;
					  //alert(actionurl);
					  window.open(actionurl,'mywindow','scrollbars=yes,fullscreen=yes,location=no,menubar=yes');
				  }	
				  if(typeOfReportVal==4)
				  {
					  actionurl="pensionOrder4.html?empId="+empno;
					  window.open(actionurl,'mywindow','scrollbars=yes,fullscreen=yes,location=no,menubar=yes');
				  }	
				  if(typeOfReportVal==5)
				  {
					  actionurl="pensionOrder5.html?empId="+empno;
					  window.open(actionurl,'mywindow','scrollbars=yes,fullscreen=yes,location=no,menubar=yes');
				  }	
				  if(typeOfReportVal==6)
				  {
					  ...
					  {
						  actionurl="pension_cal_ho_form1_report_val_action.html?empId="+empno+"&typeOfPen="+pensionType;
						  window.open(actionurl,'mywindow','scrollbars=yes,fullscreen=yes,location=no,menubar=yes');
					  }
					  if(pensionType==3)
					  {
						  actionurl="pension_cal_ho_form1_report_death_val_action.html?empId="+empno+"&typeOfPen="+pensionType;
						  window.open(actionurl,'mywindow','scrollbars=yes,fullscreen=yes,location=no,menubar=yes');
					  }
				  }	
				  if(typeOfReportVal==7)
				  {
					  actionurl="printPenAppHeadOffice.html?empId="+empno;
					  window.open(actionurl,'mywindow','scrollbars=yes,fullscreen=yes,location=no,menubar=yes');
				  }
				  if(typeOfReportVal==8)
				  {
					  if(pensionType==1 || pensionType==2)
					  {
						  actionurl="pension_cal_ho_form1_report_working_sheet_val_action.html?empId="+empno+"&typeOfPen="+pensionType;
						  window.open(actionurl,'mywindow','scrollbars=yes,fullscreen=yes,location=no,menubar=yes');
					  }
					  if(pensionType==3)
					  {
						  actionurl="pension_cal_ho_form1_report_death_working_sheet_val_action.html?empId="+empno+"&typeOfPen="+pensionType;
						  window.open(actionurl,'mywindow','scrollbars=yes,fullscreen=yes,location=no,menubar=yes');
					  }
				  }	
...
function penOrderAuthorisationReportSearch(empId)
{	
	var url="PenOrderAuthorisationReportSearch.html?empId="+empId+"&rid="+Math.random();
  ...
  if(req.readyState==4)
  {
     if(req.status==200)
      {  
       ...
       if(command=="PenOrderAuthorisationReportUserSearch")
        {         	
