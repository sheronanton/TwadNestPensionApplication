...
{	
		var url="penAppForm1FetchSettingValdata.html";		
...
function fetchMstData(empNo)
{
	...
	{
		var url="penAppForm1FetchMstValdata.html?pensionAppCalcValForm1.empNo="+empId;	 
		var req=getTransportWth();	    
		req.open("GET",url,true);        
	    req.onreadystatechange=function()
	       {
...
function fetchCalcOldData()
{
		...
		var url="penAppForm1CalcFetchOldMstValdata.html?pensionAppCalcValForm1.empNo="+empNo;	 
...
{
	var empNo = document.getElementById("empNo").value;
	var url = 'penAppForm1CalcFetchOldOthDeptServValdata.html?pensionAppCalcValForm1.empNo=' + empNo;
			...
			if (deptrid == 0)
			{
				...
				//alert(rid);
					...
					if (window.navigator.appName.toLowerCase().indexOf("netscape") == -1)
					{
						...
						hidden2=document.createElement("<input type='text'  name='othdepttodate' id='othdepttodate"+rid+"' size='10' maxlength='10' value='"+todate+"' onkeypress='dtval(this,event)' onblur='checkotherdeptdate("+rid+");' class='aetextbox' >");        	   	
					...
					if (window.navigator.appName.toLowerCase().indexOf("netscape") == -1)
					{
						...
						hidden6=document.createElement("<input type='text'  name='Departmentname' value='"+deptname+"' id='Departmentname"+rid+"' size='10'   class='recdescriptionbox' >");        	   	
...
function loadOldAE()
{
	...
	var empNo=document.getElementById("empNo").value;	
	var url='penAppForm1CalcFetchOldAEValdata.html?pensionAppCalcValForm1.empNo='+empNo;	
	var HttpAERequest = getTransportWth();
	HttpAERequest.open("GET", url, true);
	HttpAERequest.onreadystatechange=function()
     {    
...
{
	var empNo=document.getElementById("empNo").value;	
	var url='penAppForm1CalcFetchOldRecValdata.html?pensionAppCalcValForm1.empNo='+empNo+"&rid="+Math.random();
...
function fetchCommutedvalueData()
{
	...
	if((parseInt(totday)>0) || parseInt(totmonth)>0)
	{
		...
		var url="compenAppForm1CalcFetchMstValdata.html?pensionAppCalcValForm1.age="+age;	 
...
function fetchEmployeeStatusData()
{
	...
	{
		var url="empStatusAppForm1CalcFetchMstValdata.html?pensionAppCalcValForm1.classPensionId="+typepension+"&pensionAppCalcValForm1.empNo="+empNo;	 
	 ...
	 if(empstatreq.readyState==4)
	  {
	      ...
	      {  
	    	  ...
	    	  { 	    		  
	    		  ...
	    		  // else if((employeestatus.toLowerCase()=="wkg") || (employeestatus.toLowerCase()=="san"))
