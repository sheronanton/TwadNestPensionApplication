...
function penAppHeadOfficeForm1Search(command)
{
	...
	else{penAppHeadOfficeForm1Search1(command);}
	}
	...
	{
		penAppHeadOfficeForm1Search1(command);
	}	
}



function penAppHeadOfficeForm1Search1(command)
{
    ...
    if(command=="Search")
      ...
      var url="PensionApplicationHOForm1Search.html?penAppHeadOfficeform1Srch.SearchScreenKeyword="+SearchScreenKeyword+"&penAppHeadOfficeform1Srch.SearchScreenOptions="+SearchScreenOptions;
  ...
  if(req.readyState==4)
  {
     if(req.status==200)
      {  
       ...
       if(command=="PenAppHeadOfficeForm1Search")
        {         	
