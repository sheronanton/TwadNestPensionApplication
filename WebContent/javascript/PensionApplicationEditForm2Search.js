...
function searchEmp(command)
{
	...
	{		
		...
		var searchKeyword=document.getElementById("SearchKeyword").value;
			...
			if(command=="AddSearch")
				{
				var url="penAppForm2Add.html?penAppAdd.searchOption="+searchOptions+"&penAppAdd.searchKeyword="+searchKeyword;
			...
			if(command=="EditSearch")
				{	    	
					...
					var url="penAppForm2Edit.html?penAppEdit.searchOption="+searchOptions+"&penAppEdit.searchKeyword="+searchKeyword;
					var req=getTransport1();
					req.open("GET",url,true);          
						req.onreadystatechange=function()
						{
               ...
               if(len>0)            	  
                {
	              ...
	              for(var i=0;i<display.length;i++)
	                ...
	                record3[i] = baseResponse.getElementsByTagName("processStatus")[i].firstChild.nodeValue;
	...
	function loadRecordVal(page)
	{
	    ...
	    for(i=p;i<record1.length && c<__pagination;i++)
	    {
	            ...
	            cell2.setAttribute("id", "processStatus"+sno);
