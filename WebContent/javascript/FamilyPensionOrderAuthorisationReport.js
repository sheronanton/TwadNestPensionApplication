...
function GenReport()
{
	try
	{
		...
		else
		{
			...
			{
				actionurl="familyPensionOrder1.html?empId="+empno;
				window.open(actionurl,'mywindow','scrollbars=yes,fullscreen=yes,location=no,menubar=yes');
			}
			if(typeOfReportVal==2)
			{
				actionurl="familyPensionOrder2.html?empId="+empno;
				window.open(actionurl,'mywindow','scrollbars=yes,fullscreen=yes,location=no,menubar=yes');
			}	
			if(typeOfReportVal==3)
			{
				actionurl="familyPensionOrder3.html?empId="+empno;
				window.open(actionurl,'mywindow','scrollbars=yes,fullscreen=yes,location=no,menubar=yes');
			}	
...
{	
	var url="FamilyPenOrderAuthorisationReportSearch.html?empId="+empId+"&rid="+Math.random();
