...
function RevPenOrderAuthorisationReportSearch(command)
{
	...
	else{RevPenOrderAuthorisationReportSearch1(command);}
	}
	...
	{
		RevPenOrderAuthorisationReportSearch1(command);
	}	
}



function RevPenOrderAuthorisationReportSearch1(command)
{
    ...
    if(command=="Search")
      ...
      var url="RevPenOrderAuthorisationReportSearch1.html?revdcrgPenorderAuthorisationReport.penappreportSearchKeyword="+penappreportSearchKeyword+"&revdcrgPenorderAuthorisationReport.penappreportSearchOptions="+penappreportSearchOptions;
