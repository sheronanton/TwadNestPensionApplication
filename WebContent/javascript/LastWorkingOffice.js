...
function callServer1(command)
{
	...
	var opt1=document.getElementById('searchOption');
	...
	else if( opt1.selectedIndex==2 || opt1.selectedIndex==3 || opt1.selectedIndex==4)
		{
