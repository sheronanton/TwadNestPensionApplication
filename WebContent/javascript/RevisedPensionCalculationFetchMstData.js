...
{	
		var url="revisedPenCalcFetchSettingdata.html";		
...
function fetchMstDataCheckVal(empNo)
{
	...
	{
		var url="revisedPenCalculationFetchValdata.html?revPensionCalculation.empNo="+empId;
...
function fetchMstData(empNo)
{
	...
	if(empId!="" && empId.length>0)
	{
		var url="revisedPenCalculationFetchdata.html?revPensionCalculation.empNo="+empId;	 
		var req=getTransportWth();	    
		req.open("GET",url,true);        
	    req.onreadystatechange=function()
	       {
...
function fetchCalcOldData()
{
		...
		var url="revisedPenCalculationFetchOlddata.html?revPensionCalculation.empNo="+empNo;
		//alert(url);
	    	  ...
	    	  else
	    	  {
		    	  ...
		    	  for(var j=0;j<olddisplay.length;j++)
		    	  {
					...
					if(serflag=="Yes")
						...
						try
						{
						loadHOOfficeOldOtherDeptService();
...
{
	var empNo = document.getElementById("empNo").value;
	var url = 'revisedpenCalcFetchOldOthDeptServdata.html?revPensionCalculation.empNo='+empNo;
...
function loadOldAE()
{
	...
	var empNo=document.getElementById("empNo").value;	
	var url='revisedPenCalculationFetchOldAEdata.html?revPensionCalculation.empNo='+empNo;	
	var HttpAERequest = getTransportWth();
	HttpAERequest.open("GET", url, true);
	HttpAERequest.onreadystatechange=function()
     {    
...
{
		var empNo=document.getElementById("empNo").value;
		var url="penAppHOForm1CalcFetchFieldOfficeOldMstdata.html?revPensionCalculation.empNo="+empNo;	 
...
function loadFieldOFficeOldAE()
{
	...
	var empNo=document.getElementById("empNo").value;	
	var url='penAppHOForm1CalcFetchFieldOfficeOldAEdata.html?revPensionCalculation.empNo='+empNo;	
...
function fetchCommutedvalueData()
{
	...
	//alert(age);
		var url="comRevpenCalcFetchMstdata.html?revPensionCalculation.age="+age;	 
...
function fetchEmployeeStatusData()
{
	...
	{
		var url="empStatusRevPensionCalcFetchMstdata.html?revPensionCalculation.classPensionId="+typepension+"&revPensionCalculation.empNo="+empNo;	 
...
function validation_final()
{
	...
	{		
		 ...
		 /* if((grade_include=="Y")&&(grade_da=="Y"))
		  ...
		  pencalamount=lasttotal;
// 		  alert('pencalamount---    '+pencalamount);
