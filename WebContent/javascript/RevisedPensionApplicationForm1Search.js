...
function revisedpenAppForm1Search(command)
{
	...
	else{revisedpenAppForm1Search1(command);}
	}
	...
	{
		revisedpenAppForm1Search1(command);
	}	
}



function revisedpenAppForm1Search1(command)
{
    ...
    if(command=="Search")
      ...
      var url="revisedPensionCalculationSearch.html?revPenCalculationSrch.SearchScreenKeyword="+SearchScreenKeyword+"&revPenCalculationSrch.SearchScreenOptions="+SearchScreenOptions;
  ...
  if(req.readyState==4)
  {
     if(req.status==200)
      {  
       ...
       if(command=="RevisedPensionCalculationSearch")
        {         	
