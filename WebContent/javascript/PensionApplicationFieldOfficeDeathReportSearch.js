...
function penAppFeildOfficeDeathReportSearch(command)
{
	...
	else if(opt1.selectedIndex==1)
	{
		...
		{
			penAppFeildOfficeDeathReportSearch1(command);
		}
	}
...
function penAppFeildOfficeDeathReportSearch1(command)
{
    ...
    if(command=="Search")
	  {    	
      var url="PenAppFieldOfficeDeathReportSearch.html?penappfieldofficeDeathreport.penappreportSearchKeyword="+penappreportSearchKeyword+"&penappfieldofficeDeathreport.penappreportSearchOptions="+penappreportSearchOptions;
  ...
  if(req.readyState==4)
  {
     if(req.status==200)
      {  
       ...
       if(command=="PenAppFieldOfficeDeathReportUserSearch")
        {         	
