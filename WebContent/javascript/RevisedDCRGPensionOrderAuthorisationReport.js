...
function revDCRGPenOrderAuthorisationReportSearch(empId)
{	
	var url="RevDCRGPenOrderAuthorisationReportSearch.html?empId="+empId+"&rid="+Math.random();
  ...
  if(req.readyState==4)
  {
     if(req.status==200)
      {  
       ...
       if(command=="RevDCRGPenOrderAuthorisationReportUserSearch")
        {         	
