...
StringBuffer menusubCheck=new StringBuffer();
	...
	String MajorSystemDesc="select Major_System_Short_Desc,Major_System_Id from SEC_MST_MAJOR_SYSTEMS where Major_System_Id in( select distinct(Major_System_Id) from SEC_MST_ROLE_MENUS where Role_Id in("+temp+")) and Major_System_Id in('HRS')";
