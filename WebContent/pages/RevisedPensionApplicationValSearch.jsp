...
<title>Search Revised Pension Calculation For Validate</title>
<link rel=StyleSheet href="<s:url value="/css/Sample3.css" />"
	type="text/css">
	
<script
	src="<s:url value="/javascript/RevisedPensionApplicationValSearch.js" />"
...
function post_valueFamSrch(){
	...
	document.getElementById("revisedpenCalcempNo").value=emp_no_td_value;
...
<s:form action=""	name="" namespace="/pages">
	<table width="70%" align="center" border="1">
		<tr>
			<td colspan="4" background="../images/bluebg1.jpg" align="center"><font	color="white" size="3"><strong>Search Revised Pension Calculation For Validate</strong></font></td>
		</tr>
		<tr>
			<td align="center" height="30" valign="middle">			
			<s:select headerKey=""
				headerValue="-- Select --" id="SearchScreenOptions" name="revPenCalculationValSrch.SearchScreenOptions"
				list="#{'2':'Emp No','3':'Employee Name'}"
				theme="simple" cssStyle="border:#ffba14 1.5px solid"  onchange="javascript:cleanTbodyFai()" />&nbsp;&nbsp;
			<s:textfield  id="SearchScreenKeyword" name="revPenCalculationValSrch.SearchScreenKeyword" theme="simple"
				cssStyle="border:#ffba14 1.5px solid" />&nbsp;&nbsp; 
			<input type="button" id="Search" name="Search" Value="Search"
				onclick="javascript:revisedpenAppValSearch('Search')" />&nbsp;&nbsp;
			<input type="reset" id="btnClear" name="Clear" value="Clear" onclick="javascript:cleanTbodyFai()" />
			<s:hidden name="" id="revisedpenCalcempNo" theme="simple">
			</s:hidden>
