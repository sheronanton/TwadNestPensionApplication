...
<html>
<head>
<title><s:text name="label.fampenapp" /></title>
	<s:head theme="ajax" />	
...
<body>
<br>
<s:form name="" action="famPenAppFieldForm2SaveAction" method="POST"  namespace="/pages" onsubmit="return submitValidationCheck();" >
...
<table border="1" align="center" width="100%" class="tableGrid"> 
		<tr>
			<td colspan="6" background="../images/bluebg1.jpg"><font color="white" size="4"><s:text name="label.fampenapp" /></font></td>
		</tr>
		...
		<tr>
			<td align="center" colspan="6">
				...
				<font class="bodyText">Employee No  </font> <font color="red" class="bodyTextBold" > *</font> :
			<s:textfield name="penEmpNo" id="penEmpNo" maxlength="10" theme="simple" cssClass="textbox" onchange="numchk(this);javascript:checkAvailForm2(this.value);" >	</s:textfield>&nbsp;
				<input type="button" name="Select" value="Select" onclick="window.open('FamilyPensionApplicationDeathFieldForm2Search.jsp','mywindow','width=800,height=500,scrollbars=yes')" /> &nbsp;
				<input type="button" name="Clear" value="Clear" onclick="javascript:clearAllData();" />				<!-- fetchMstValue(this.value); -->
			</td>			
		</tr>
		...
		<tr>
			...
			<td width="15%">
				<s:hidden name="penAppFamDeathCo.empNo" id="empNo"  theme="simple" cssClass="readonlytext" />
		...
		<tr>
			...
			<td><s:select name="penAppFamDeathCo.religionId" id="religionId" list="religionCombo" listKey="religionCode" listValue="religionName" headerKey="0" headerValue="--Select--" cssStyle="border:#ffba14 1.5px solid" /></td>
		</tr>
		
		<!--<tr>			
			<td><font class="bodyText"><s:text name="label.nationality" /></font></td>
			<td><s:textfield name="penAppFamDeathCo.nationality" id="nationality" theme="simple" cssClass="textbox" onchange="charOnly(this);" onblur="charOnly(this);"  /></td>				
			<td><font class="bodyText"><s:text name="label.idmark1"  /></font></td>
			<td ><s:textarea name="penAppFamDeathCo.idMark1" id="idMark1" theme="simple" rows="3" cols="15" onchange="alphanumeric(this);" onblur="alphanumeric(this);" cssStyle="border:#ffba14 1.5px solid" /></td>		
			<td><font class="bodyText"><s:text name="label.idmark2" /></font></td>
			<td><s:textarea name="penAppFamDeathCo.idMark2" id="idMark2" theme="simple" rows="3" cols="15" onchange="alphanumeric(this);" onblur="alphanumeric(this);" cssStyle="border:#ffba14 1.5px solid" /></td>	
		</tr>
		
		-->		
		<tr>			
			<td ><font class="bodyText"><s:text name="label.presentaddress" /></font> <font color="red" class="bodyTextBold" > *</font> </td>
			<td ><s:textarea name="penAppFamDeathCo.presentAddress" id="presentAddress" theme="simple" rows="3" cols="15" cssStyle="border:#ffba14 1.5px solid" /></td>				
			<td ><font class="bodyText"><s:text name="label.state" /></font></td>
			<td><s:select name="penAppFamDeathCo.stateId" id="stateId" list="stateList" listKey="stateId" listValue="stateName" headerKey="0" headerValue="--Select--" cssStyle="border:#ffba14 1.5px solid" /></td>		
			<td><font class="bodyText"><s:text name="label.penpayoffice" /></font> <font color="red" class="bodyTextBold" > *</font> </td>
			<td ><s:select name="penAppFamDeathCo.paymentOfficeId" id="paymentOfficeId" list="payOfficeList" listKey="currAccountOfficeId1" listValue="currAccountOfficeName" headerKey="0" headerValue="--Select--"  cssStyle="border:#ffba14 1.5px solid" /></td>	
		</tr>
...
<div id="tabs" style="background-color:#FFEEBA">
	...
	<div id="tabs-1" style="background-color: #E9F5F5;">	
		...
		<tr>					
			...
			<td width="15%"><s:textfield name="penAppFamDeathCo.claimentName" id="claimentName" maxlength="40" theme="simple" cssClass="textbox" /></td>		
			<td width="20%"><font class="bodyText"><s:text name="label.claimentdob" /></font></td>
			<td width="15%">
				<s:textfield name="penAppFamDeathCo.claimentDob1" id="claimentDob" size="10" maxlength="10" theme="simple" onchange="return CheckDate(this);" onblur="return CheckDate(this);" cssClass="textbox" onkeyup="dtval(this,event);" />
			...
			<td width="15%"><s:textfield name="penAppFamDeathCo.claimentAge" id="claimentAge" size="3" onchange="numchk(this);" onblur="numchk(this);" maxlength="3" theme="simple" cssClass="textbox" /></td>	
			
		</tr>
		
		<tr>					
			<td width="20%"><font class="bodyText"><s:text name="label.idmark1" /></font> <font color="red" class="bodyTextBold" > *</font> </td>
			<td width="15%"><s:textarea name="penAppFamDeathCo.idMark1" id="idMark1" theme="simple" rows="3" cols="15" onchange="alphanumeric(this);" onblur="alphanumeric(this);" cssStyle="border:#ffba14 1.5px solid" /></td>		
			<td width="20%"><font class="bodyText"><s:text name="label.idmark2" /></font></td>
			<td width="15%"><s:textarea name="penAppFamDeathCo.idMark2" id="idMark2" theme="simple" rows="3" cols="15" onchange="alphanumeric(this);" onblur="alphanumeric(this);" cssStyle="border:#ffba14 1.5px solid" /></td>			
			<td width="20%"><font class="bodyText">Height</font></td>
			<td width="15%"><s:textfield name="penAppFamDeathCo.height" id="height" size="3" theme="simple" cssClass="textbox" /></td>	
			
		</tr>
		
		<tr>	
			<td width="20%"><font class="bodyText"><s:text name="label.guardianname" /></font></td>
			<td width="15%"><s:textfield name="penAppFamDeathCo.guardianName" id="guardianName" maxlength="" theme="simple" cssClass="textbox" /></td>				
			<td width="20%"><font class="bodyText"><s:text name="label.guardiandob" /></font></td>
			<td width="15%">
				<s:textfield name="penAppFamDeathCo.guardianDob1" id="guardianDob" size="10" maxlength="10" theme="simple" onblur="return CheckDate(this);" onchange="return CheckDate(this);" cssClass="textbox" onkeyup="dtval(this,event);"  />
			...
			<td width="15%"><s:textfield name="penAppFamDeathCo.guardianRelationMinor" id="guardianRelationMinor" maxlength="40" theme="simple" cssClass="textbox" /></td>							
										
		</tr>
		<tr>
			<td width="20%"><font class="bodyText"><s:text name="label.guardianrelation" /></font></td>
			<td width="15%"><s:textfield name="penAppFamDeathCo.guardianRelationEmp" id="guardianRelationEmp" maxlength="40" theme="simple" cssClass="textbox" /></td>
			<td width="20%"><font class="bodyText"><s:text name="label.empdeathdate" /></font><font color="red" class="bodyTextBold" > *</font></td>
			<td width="15%">
			<s:textfield name="penAppFamDeathCo.employeeDeathDate1" id="employeeDeathDate" size="10" maxlength="10" theme="simple" onblur="return CheckDate(this);" onchange="return CheckDate(this);" cssClass="textbox" onkeyup="dtval(this,event);" />
			...
			<td width="15%"><s:textarea name="penAppFamDeathCo.address" id="address" theme="simple" rows="3" cols="15" cssStyle="border:#ffba14 1.5px solid" /></td>			
		</tr>
