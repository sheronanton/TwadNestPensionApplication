...
<title>Pensioner Listing for DCRG Revised Due to DA Change</title>
<link rel=StyleSheet href="<s:url value="/css/Sample3.css" />"	type="text/css">
	
	
<script src="<s:url value="/javascript/RevisedPensionDCRGDASearch.js" />" type="text/javascript"> </script>
...
<br>
<br>
<body onload="javascript:loadDatas();">
<s:hidden name="selectedradio" id="selectedradio" />
<s:hidden name="rowcount" id="rowcount" />
<s:hidden name="radios" id="radios" />

<s:form action="loadRevDCRGPenValidDataDuetoDa.html" name="" namespace="/pages">
	<table border="1" width="70%" align="center">
		<tr>
			<td  background="../images/bluebg1.jpg"><font
				color="white" size="4"><strong>Pensioner Listing for DCRG Revised Due to DA Change</strong></font></td>
		</tr>
		...
		<tr>
			...
			<input type="button" id="Search" name="Search" Value="Search"
				onclick="javascript:searchOperation('HOSearch')" />&nbsp;&nbsp;
