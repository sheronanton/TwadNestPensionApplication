...
<title>Search Pension Application Form1 (Calculation) For Add/Edit -Field Office</title>
<link rel=StyleSheet href="<s:url value="/css/Sample3.css" />"
	type="text/css">
	
<script
	src="<s:url value="/javascript/PensionApplicationForm1Search.js" />"
...
<s:form action=""	name="" namespace="/pages">
	<table width="70%" align="center" border="1">
		<tr>
			<td colspan="4" background="../images/bluebg1.jpg" align="center"><font	color="white" size="3"><strong>Pension Calculation -Field Office Search </strong></font></td>
		</tr>
		<tr>
			...
			<s:textfield  id="SearchScreenKeyword" name="penAppform1Srch.SearchScreenKeyword" theme="simple"
