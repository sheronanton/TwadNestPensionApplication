...
<script	src="<s:url value="/javascript/PensionApplicationFieldOfficeReport.js" />"	type="text/javascript"></script>
<style type="text/css">
	table.border1 
	{
...
<s:form name="FieldOfficeReport" action="" method="POST"  namespace="/pages" >
	<table border="0" align="center" width="80%" style="background-color:#E9F5F5;">
		<tr>
			<td background="../images/bluebg1.jpg"><font color="white" size="4">Pension Application - Field Office Report</font></td>
		</tr>
		<tr>
			<td align="center">			
				<table align="center" width="100%" class="border1" cellpadding="0" cellspacing="0">
					...
					<tr>
						...
						<td align="left" width="50%">
						 	<s:select list="#{'1':'Annexure Form 5','2':'Annexure Form 5 Page 2','3':'Application form Pension or Gratuity 1','4':'Application form Pension or Gratuity 2','5':'Form for Assessing Pension and Gratuity 1','6':'Form for Assessing Pension and Gratuity 2','7':'Form for Assessing Pension and Gratuity 3','8':'Details of Family','9':'Pension Calculation Field Office Report','16':'Pension Application Field Office Report','10':'Speciman Signature','11':'Descriptive Roll','12':'Attested Join Photograph','13':'Consent Letter','14':'Consent Letter for Recovery','15':'Form of Declaration','17':'No Due Certificate','18':'Working Sheet'}" headerKey="" headerValue="--Select--" id="reportformId" name="reportform" />							
						</td>		
					</tr>	
					<tr>
