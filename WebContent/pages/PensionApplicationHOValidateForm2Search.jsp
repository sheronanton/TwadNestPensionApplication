...
<title>Application Listing for Head Office - Validate</title>
<link rel=StyleSheet href="<s:url value="/css/Sample3.css" />"	type="text/css">
	
	
<script src="<s:url value="/javascript/PensionApplicationHOValidate.js" />" type="text/javascript"> </script>
...
<s:form action="penAppLoadHeadOfficeEditData.html" name="" namespace="/pages">
	<table border="1" width="70%" align="center">
		<tr>
			<td  background="../images/bluebg1.jpg"><font
				color="white" size="4"><strong>Application Listing for Head Office  - Validate</strong></font></td>
		</tr>
