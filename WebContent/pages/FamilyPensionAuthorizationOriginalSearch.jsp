...
<title>Pension Authorization Search -(Original)</title>
<link rel=StyleSheet href="<s:url value="/css/Sample3.css" />"	type="text/css">
	
	
<script src="<s:url value="/javascript/FamilyPensionAuthorizationOriginal.js" />" type="text/javascript"> </script>
...
opener.document.pensionAuthorizationOriginal.empNo.value=emp_no_td_value;
	...
	<table border="1" width="70%" align="center">
		<tr>
			<td  background="../images/bluebg1.jpg"><font
				color="white" size="4"><strong>Pension Authorization Search - (Original)</strong></font></td>
		</tr>
