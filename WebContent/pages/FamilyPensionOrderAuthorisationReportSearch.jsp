...
<title>Family Pension Order - Authorisation Report Search</title>
<link rel=StyleSheet href="<s:url value="/css/Sample3.css" />"
	type="text/css">
	
<script
	src="<s:url value="/javascript/FamilyPensionOrderAuthorisationReportSearch.js" />"
...
<s:form action=""	name="" namespace="/pages">
	<table width="70%" align="center" border="1">
		<tr>
			<td colspan="4" background="../images/bluebg1.jpg" align="center"><font	color="white" size="3"><strong>Family Pension Order - Authorisation Report Search </strong></font></td>
		</tr>
		<tr>
			...
			<input type="button" id="Search" name="Search" Value="Search" onclick="javascript:penOrderAuthorisationReportSearch('Search')" />&nbsp;&nbsp;
