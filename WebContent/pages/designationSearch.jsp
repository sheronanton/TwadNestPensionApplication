...
<title>Designation Search</title>
<link rel="StyleSheet" href="<s:url value="/css/Sample3.css" />" type="text/css">
	
<script src="<s:url value="/javascript/DesignationSearch.js" />" type="text/javascript">
</script>
...
function postITRecoverSearch()
{
	...
	var em_designation_value=document.getElementById("designation"+sel_value).innerHTML;
...
<s:form action="" name="" namespace="/pages">
	<table border="1" width="90%" align="center">
		...
		<tr>
			<td  background="../images/bluebg1.jpg"><font color="white" size="4"><strong>Employee Designation Search</strong></font></td>
		</tr>
		...
		<tr>
			...
			<table id="Existing" border="0" width="100%" cellspacing="0"
				...
				<tr>
					...
					<th rowspan="2" align="center" width="40%">Designation</th>	
				</tr>
