...
<s:form name="PensionOrderAuthorisationReport" action="" method="POST"  namespace="/pages" >
	<table border="0" align="center" width="80%" style="background-color:#E9F5F5;">
		<tr>
			<td background="../images/bluebg1.jpg"><font color="white" size="4">Pension Order - Authorisation Report</font></td>
		</tr>
		<tr>
			<td align="center">			
				<table align="center" width="100%" class="border1" cellpadding="0" cellspacing="0">
					<tr>
						...
						<td align="left" width="50%">
							...
							<input type="button" name="" value="Select Emp.No." onclick="window.open('PensionOrderAuthorisationReportSearch.jsp','PensionOrderAuthorisationReportSearch','width=1000,height=600,scrollbars=yes')" />
					...
					<tr>
						...
						<td align="left" width="50%">
						 	<s:select list="#{'1':'Pension Order 1','2':'Pension Order 2','3':'Pension Order 3','4':'Pension Order 4','5':'Pension Order 5','6':'Pension Calculation Head Office Report','7':'Pension Application Head Office Report','8':'Working sheet'}" headerKey="" headerValue="--Select--" id="reportformId" name="reportform" />							
						</td>		
					</tr>	
					<tr>
