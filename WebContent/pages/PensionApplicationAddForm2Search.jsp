...
<title>Add - Pension Application Form 2</title>
<link rel=StyleSheet href="<s:url value="/css/Sample3.css" />"	type="text/css">
	
	
<script src="<s:url value="/javascript/PensionApplicationAddForm2Search.js" />" type="text/javascript"> </script>
...
function postValue()
{
	...
	opener.checkAvailForm1(emp_no_td_value);	
	window.close();	
}
...
<s:form  name="searchform" namespace="/pages" action="" method="POST">
	<table border="1" width="70%" align="center">
		<tr>
			<td  background="../images/bluebg1.jpg">
			<font color="white" size="4"><strong>Add - Pension Application Form 2</strong></font></td>
		</tr>
		...
		<tr>
			...
			<input type="button" id="Search" name="Search" value="Search" onclick="searchEmp('AddSearch');" />&nbsp;&nbsp;
		...
		<tr>
			...
			<table border="1" width="100%" align="center"
				...
				<tr>
					...
					<select name="cmbpagination" id="cmbpagination" onchange="javascript:changepagesize();">
					...
					<table border="0">
						...
						<tr>
							...
							<div id="divcmbpage" style="display: none"><font
								color="Black" size="2"><strong> Page&nbsp;&nbsp;
								<select name="cmbpage" id="cmbpage" onchange="javascript:changepage();"></select></strong></font></div>
	...
	<br>
	<center><input type="submit" name="Submit" id="Submit" value="Submit" onclick="javascript:postValue();" disabled="disabled"/> 
