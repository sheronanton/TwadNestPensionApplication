...
<script  src="<s:url value="/javascript/unfreezepensioncalculation.js" />" type="text/javascript">
</script>
			...
			<s:if test="msg != null">
			  <div class="warning"><s:property value="msg"/></div>
				...
				<tr>
					...
					<s:submit action="unfreezeaction" value="UNFREEZE" name="unfreeze" id="unfreeze"/>
