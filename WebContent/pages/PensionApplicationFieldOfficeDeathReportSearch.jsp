...
<title>Pension Application -Field Office Death Report Search</title>
<link rel=StyleSheet href="<s:url value="/css/Sample3.css" />"
	type="text/css">
	
<script
	src="<s:url value="/javascript/PensionApplicationFieldOfficeDeathReportSearch.js" />"
...
function post_valueFamSrch(){
	...
	document.getElementById("penAppFieldOfficeempNo").value=emp_no_td_value;

	opener.document.FieldOfficeDeathReport.empNo.value=emp_no_td_value;	
	opener.document.FieldOfficeDeathReport.empName.value=emp_name_td_value;
	opener.penAppFeildOfficeDeathReportSearch1("Search");	
	window.close();
...
<s:form action=""	name="" namespace="/pages">
	<table width="70%" align="center" border="1">
		<tr>
			<td colspan="4" background="../images/bluebg1.jpg" align="center"><font	color="white" size="3"><strong>Pension Application -Field Office Death Report Search </strong></font></td>
		</tr>
		<tr>
			<td align="center" height="30" valign="middle">
			<s:select headerKey=""
				headerValue="-- Select --" id="penappreportSearchOptions" name="penappfieldofficeDeathreport.penappreportSearchOptions"
				list="#{'1':'Emp No','2':'Employee Name'}"
				theme="simple" cssStyle="border:#ffba14 1.5px solid"  onchange="javascript:cleanTbodyFai()" />&nbsp;&nbsp;
			<s:textfield  id="penappreportSearchKeyword" name="penappfieldofficeDeathreport.penappreportSearchKeyword" theme="simple"
				cssStyle="border:#ffba14 1.5px solid" />&nbsp;&nbsp; 
			<input type="button" id="Search" name="Search" Value="Search"
				onclick="javascript:penAppFeildOfficeDeathReportSearch('Search')" />&nbsp;&nbsp;
			<input type="reset" id="btnClear" name="Clear" value="Clear" onclick="javascript:cleanTbodyFai()" />
			<s:hidden name="" id="penAppFieldOfficeempNo" theme="simple">
			</s:hidden>  
	        </td>
		</tr>
		<tr>
