...
<title>Edit -  Application Listing for Head Office </title>
<link rel=StyleSheet href="<s:url value="/css/Sample3.css" />"	type="text/css">

<script type="text/javascript" src="../javascript/FamilyPensionApplicationDeathHOForm2Search.js"></script>
...
function postValue()
{
	...
	document.getElementById("famPenHOEditEmpNo").value=emp_no_td_value;
	opener.document.famPenAppHOEditForm2.penEmpNo.value=emp_no_td_value;
...
<s:form action="" name="familyPensionHOApplication" namespace="/pages">
	<table border="1" width="70%" align="center">
		<tr>
			<td  background="../images/bluebg1.jpg"><font
				color="white" size="4"><strong> Edit - Application Listing for Head Office </strong></font></td>
		</tr>
		...
		<tr>
			...
			<input type="button" id="Search" name="Search" Value="Search"
				onclick="javascript:SearchData('editSearch')" />&nbsp;&nbsp;
			
			<input type="reset" id="btnClear" name="Clear" value="Clear" onclick="javascript:cleanTbody()" />
		
		<s:hidden name="famPenHOEditEmpNo" id="famPenHOEditEmpNo" />	
		</td>
		</tr>
	...
	<br>
	<center><input type="button" name="Submit" id="Submit" value="Submit" onclick="javascript:postValue();"/> 
