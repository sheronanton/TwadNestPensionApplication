...
<title>Validate -  Application Listing for Head Office </title>
...
function postValue()
{
	...
	document.getElementById("famPenHOValidateEmpNo").value=emp_no_td_value;    
...
<s:form action="famPenAppHoValidateLoadForm.html" name="familyPensionHOApplication" namespace="/pages">
	<table border="1" width="70%" align="center">
		<tr>
			<td  background="../images/bluebg1.jpg"><font
				color="white" size="4"><strong> Validate - Application Listing for Head Office </strong></font></td>
		</tr>
		...
		<tr>
			...
			<input type="button" id="Search" name="Search" Value="Search"
				onclick="javascript:SearchData('validateSearch')" />&nbsp;&nbsp;
			
			<input type="reset" id="btnClear" name="Clear" value="Clear" onclick="javascript:cleanTbody()" />
		
		<s:hidden name="famPenHOValidateEmpNo" id="famPenHOValidateEmpNo" />	
		</td>
		</tr>
	...
	<br>
	<center><s:submit name="Submit" id="Submit" value="Submit" onclick="javascript:postValue();"/> 
