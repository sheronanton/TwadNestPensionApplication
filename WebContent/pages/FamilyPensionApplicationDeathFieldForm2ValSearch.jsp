...
<s:form action="famPenAppFieldForm2LoadData.html" name="familyPensionAplication" namespace="/pages">
	<table border="1" width="70%" align="center">
		<tr>
			<td  background="../images/bluebg1.jpg"><font
				color="white" size="4"><strong>Application Listing for  Field Office - Validate</strong></font></td>
		</tr>
