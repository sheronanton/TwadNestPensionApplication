...
<title>Search Pension Application Form1 (Calculation) For Add/Edit -Head Office</title>
<link rel=StyleSheet href="<s:url value="/css/Sample3.css" />"
	type="text/css">
	
<script
	src="<s:url value="/javascript/PensionApplicationHeadOfficeForm1Search.js" />"
...
<s:form action=""	name="" namespace="/pages">
	<table width="70%" align="center" border="1">
		<tr>
			<td colspan="4" background="../images/bluebg1.jpg" align="center"><font	color="white" size="3"><strong>Search Pension Application Form1 (Calculation) For Add/Edit -Head Office </strong></font></td>
		</tr>
		<tr>
			<td align="center" height="30" valign="middle">			
			<s:select headerKey=""
				headerValue="-- Select --" id="SearchScreenOptions" name="penAppHeadOfficeform1Srch.SearchScreenOptions"
				list="#{'2':'Emp No','3':'Employee Name'}"
				theme="simple" cssStyle="border:#ffba14 1.5px solid"  onchange="javascript:cleanTbodyFai()" />&nbsp;&nbsp;
			<s:textfield  id="SearchScreenKeyword" name="penAppHeadOfficeform1Srch.SearchScreenKeyword" theme="simple"
