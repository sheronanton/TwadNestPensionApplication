...
<script type="text/javascript" src="../javascript/PensionAuthorizationOriginal.js"></script>
<script type="text/javascript" src="../javascript/PensionApplicationCommon.js"></script>
<title><s:text name="label.penauthtitle" /></title>
...
<s:form name="pensionAuthorizationOriginal" action="penAuthoriseSaveData" onsubmit="return checkAppSubmit();">
<table border="0" align="center" width="80%" style="background-color:#E9F5F5" cellpadding="0" cellspacing="0" class="border1">
	...
	<tr>
		<td colspan="4" background="../images/bluebg1.jpg"><font class="textHeader"><b><s:text name="label.penauthtitle" /></b></font></td>		
	</tr>
	...
	<tr>
		...
		<input type="button" value="Fetch" onclick="javascript:window.open('PensionAuthorizationOriginalSearch.jsp','window','width=800,height=500,scrollbars=yes');" /></td>
	...
	<tr>
		...
		<s:textarea name="penAppAuthOri.residentialAddress" id="empAddress" theme="simple" rows="3" cols="25" cssStyle="border:#ffba14 1.5px solid" 
			onchange="specialcharecter(this.form.empAddress);">
		</s:textarea>
	...
	<tr>
	<td>
	<font class="bodyText" ><s:text name="label.datedon" /><font color="red">*</font></font>&nbsp;</td>
