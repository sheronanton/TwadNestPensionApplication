...
<title>Pension Application -Field Office Report Search</title>
<link rel=StyleSheet href="<s:url value="/css/Sample3.css" />"
	type="text/css">
	
<script
	src="<s:url value="/javascript/PensionApplicationFieldOfficeReportSearch.js" />"
...
function post_valueFamSrch(){
	...
	opener.document.FieldOfficeReport.empNo.value=emp_no_td_value;	
	opener.document.FieldOfficeReport.empName.value=emp_name_td_value;
	opener.penAppFeildOfficeReportSearch1("Search");	
	window.close();
...
<s:form action=""	name="" namespace="/pages">
	<table width="70%" align="center" border="1">
		<tr>
			<td colspan="4" background="../images/bluebg1.jpg" align="center"><font	color="white" size="3"><strong>Pension Application -Field Office Report Search </strong></font></td>
		</tr>
		<tr>
			<td align="center" height="30" valign="middle">
			<s:select headerKey=""
				headerValue="-- Select --" id="penappreportSearchOptions" name="penappfieldofficereport.penappreportSearchOptions"
				list="#{'2':'Emp No','3':'Employee Name'}"
				theme="simple" cssStyle="border:#ffba14 1.5px solid"  onchange="javascript:cleanTbodyFai()" />&nbsp;&nbsp;
			<s:textfield  id="penappreportSearchKeyword" name="penappfieldofficereport.penappreportSearchKeyword" theme="simple"
				cssStyle="border:#ffba14 1.5px solid" />&nbsp;&nbsp; 
			<input type="button" id="Search" name="Search" Value="Search"
				onclick="javascript:penAppFeildOfficeReportSearch('Search')" />&nbsp;&nbsp;
