...
<script src="<s:url value="/javascript/RevisedDCRGSearch.js" />" type="text/javascript"> </script>
...
<s:form action="LoadRevDCRGPenAppHeadDataToRevised.html" name="" namespace="/pages">
