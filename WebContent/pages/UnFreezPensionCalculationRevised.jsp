...
<script  src="<s:url value="/javascript/unfreezepensioncalculationrevised.js" />" type="text/javascript">
</script>
		...
		<td align="center">
			...
			<s:if test="msg != null">
			  <div class="warning"><s:property value="msg"/></div>
				...
				<tr>
					<th colspan="2" background="../images/bluebg1.jpg" style="color:#FFFFFF; font-size:15px;">Unfreeze Pension Calculation Form</th>
				</tr>	
				<tr>
				...
				<tr>
					...
					<s:submit action="unfreezeactionrevised" value="UNFREEZE" name="unfreeze" id="unfreeze"/>
