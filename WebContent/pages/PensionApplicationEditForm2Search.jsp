...
<title>Edit - Pension Application Form 2</title>
...
function postValue()
{
	...
	document.getElementById("penAppEditHiddenEmpId").value=emp_no_td_value;
...
<s:form action="PenAppForm2EditDataLoad.html" name="" namespace="/pages">
	<table border="1" width="70%" align="center">
		<tr>
			<td  background="../images/bluebg1.jpg"><font
				color="white" size="4"><strong>Edit - Pension Application Form 2</strong></font></td>
		</tr>
		...
		<tr>
			...
			<input type="button" id="Search" name="Search" Value="Search"
				onclick="javascript:searchEmp('EditSearch')" />&nbsp;&nbsp;
			
			<input type="reset" id="btnClear" name="Clear" value="Clear" onclick="javascript:cleanTbody()" />
		
		<s:hidden name="penAppEditHiddenEmpId" id="penAppEditHiddenEmpId" />	
		</td>
		</tr>
