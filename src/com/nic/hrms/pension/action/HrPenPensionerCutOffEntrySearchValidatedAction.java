...
public class HrPenPensionerCutOffEntrySearchValidatedAction extends BaseAction {

	
	private static final long serialVersionUID = 7739034991199243322L;
    private HrPenPensionerCutOffEntrySearchValidated_service searchvalidateservice;
	...
	public String searchvalidate(){
		try{
			
			HttpSession session=getRequest().getSession();
		    UserProfile empProfileVal=(UserProfile)session.getAttribute("UserProfile");
		    int empId = empProfileVal.getEmployeeId();
			...
			boolean flag = false;
			objsearchlist=searchvalidateservice.searchuser1(searchText,options,empId);
	...
	public void setSearchvalidateservice(HrPenPensionerCutOffEntrySearchValidated_service searchvalidateservice) {
		this.searchvalidateservice = searchvalidateservice;
	}
	public HrPenPensionerCutOffEntrySearchValidated_service getSearchvalidateservice() {
		return searchvalidateservice;
	}	
}	