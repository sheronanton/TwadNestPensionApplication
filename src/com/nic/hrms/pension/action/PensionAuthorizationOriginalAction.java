...
public class PensionAuthorizationOriginalAction extends BaseAction{
	...
	private PensionAuthorizationOriginalDao penAppAuthOri;
	...
	public String checkPpoNo()
	{
		...
		System.out.println("Inside PPO NO check Action ");
			...
			checkPpoList=penAuthOriService.checkPpoNo(ppoNo);
	...
	public String loadOfficeAddress()
	{
		try
		{
			...
			addressList=penAuthOriService.getAddress(officeId);
	...
	public String getMstData()
	{
		try
		{
			...
			if(empNo!=null)
			{			
				mstDataList=penAuthOriService.getMasterDetails(empNo);
				nomineeList=penAuthOriService.getNominee(empNo);
				
				System.out.println("Size of mstDataList List is : "+mstDataList.size());
...
//					xmlString.append("<authOfficerAddress>NA</authOfficerAddress>");
	...
	public String getRelation()
	{
		try
		{
			...
			nomineeDetailList=penAuthOriService.getNominDetails(empNo, nomId);
	...
	public String searchAction()
	{
		...
		{	
			...
			searchList=penAuthOriService.searchOperation(opt, key);
	...
	public void setPenAppAuthOri(PensionAuthorizationOriginalDao penAppAuthOri) {
		this.penAppAuthOri = penAppAuthOri;
	}


	public PensionAuthorizationOriginalDao getPenAppAuthOri() {
