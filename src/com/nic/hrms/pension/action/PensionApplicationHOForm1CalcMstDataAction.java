...
import com.nic.hrms.pension.model.PensionApplicationHOForm1OthDeptServiceDaoPK;
...
public class PensionApplicationHOForm1CalcMstDataAction extends BaseAction {

	/**
	 * 
	 */
	private static final long serialVersionUID = 2580606530771088937L;
	private PensionApplicationHOForm1CalcMstDataService penappmHeadOfficeform1calcservice;
	private PensionApplicationCalcSearchModel penAppHOCalcComm;
	private PensionApplicationHOForm1Dao pensionAppCalcHOForm1;
	...
	private List<PensionApplicationHOForm1AverageEmolumentsDao> ho_form1aemultidatlist;
	
	
	private List<String> rec_description;
	private List<Integer> rec_amount;
	
	private List<PensionApplicationHOForm1RecoveriesDao> ho_form1recmultidatlist;
	private List<PensionApplicationHOForm1OthDeptServiceDao> ho_form1othdeptservicelist;
	...
	public String loadSettingData()
	{
		...
		try
		{
			...
			mysettingList=penappmHeadOfficeform1calcservice.penAppHOForm1CalcSettingData();
			myavgsettingList=penappmHeadOfficeform1calcservice.penAppHOForm1CalcAvgSettingData();			
			  int dapercentage=0;
	...
	public String loadPenAppHOForm1MstData()
	{
		int loginEmpId=0;
		int curloginEmpId=0;
		...
		try
		{
			...
			loginEmpId=pensionAppCalcHOForm1.getEmpNo();
			
					
			myList=penappmHeadOfficeform1calcservice.penAppHOForm1MstData(loginEmpId,curloginEmpId);
			int dapercentage=0;
			...
			{				
				for(Object[] tl: myList)
				 {
					...
					if(temp[17]!=null)
					{
						...
						dapercentage=penappmHeadOfficeform1calcservice.penAppHOForm1CalcdaSettingData(dor);
					}
					else
					{
			 ...
			 getResponse().setContentType("text/xml");
			 System.out.println("xml after employee number confirmation----->"+xmlString);
			 out.println(xmlString.toString());
			 out.flush();
			 out.close();
	...
	public String loadPenAppHOForm1MstCheckValData()
	{
		...
		try
		{
			...
			myCheckvalList=penappmHeadOfficeform1calcservice.penAppHOForm1MstCheckValData(loginEmpId,curloginEmpId);
	...
	public String loadPenAppHOofficeOlddeptserviceData()
	{
		...
		PrintWriter out = getResponse().getWriter();
		empId=pensionAppCalcHOForm1.getEmpNo();
		...
		List<PensionApplicationHOForm1OthDeptServiceDao> othdeptserli=penappmHeadOfficeform1calcservice.loadHOOfficeForm1OldOtherDepServiceVal(empId);
	...
	public String loadPenAppHOForm1OldMstData()
	{
		int loginEmpId=0;
		...
		try
		{
			...
			UserProfile empProfile=(UserProfile)session.getAttribute("UserProfile");
			loginEmpId=pensionAppCalcHOForm1.getEmpNo();
			myOldList=penappmHeadOfficeform1calcservice.penAppHOForm1CalcOldMstData(loginEmpId);
			...
			{				
			 ...
			 getResponse().setContentType("text/xml");
			 System.out.println("oldxmlString before");
			 System.out.println("3,employee_record----->"+oldxmlString);
	...
	public String loadPenAppHOForm1OldAEData()
	{
	...
	try
		...
		List<PensionApplicationHOForm1AverageEmolumentsDao> aeli=penappmHeadOfficeform1calcservice.loadHOForm1OldAe(empId);
	...
	public String loadPenAppHOForm1OldRecoveryData()
	{
	...
	try
		...
		List<PensionApplicationHOForm1RecoveriesDao> recli=penappmHeadOfficeform1calcservice.loadHOForm1OldRecoveries(empId);
	...
	// FIELD OFFICE VALIDATED REC0RD FETCHING START
	
	public String loadPenAppHOForm1FieldOfficeOldMstData()
	{
		int loginEmpId=0;
		List<Object[]> myOldList=null;		
		StringBuffer oldxmlString = new StringBuffer();
		...
		try
		{
			...
			UserProfile empProfile=(UserProfile)session.getAttribute("UserProfile");
			loginEmpId=pensionAppCalcHOForm1.getEmpNo();
			myOldList=penappmHeadOfficeform1calcservice.penAppHOForm1CalcFieldOfficeOldMstData(loginEmpId);
	...
	public String loadPenAppHOForm1FieldOfficeOlddeptserviceData()
	{
		Integer empId=0;
		try
		{
		...
		List<PensionApplicationForm1OthDeptServiceValDao> othdeptserli=penappmHeadOfficeform1calcservice.loadForm1OldOtherDepServiceVal(empId);
		for(PensionApplicationForm1OthDeptServiceValDao othdeptsertmp:othdeptserli)
		{
	...
	public String loadPenAppHOForm1FieldOfficeOldAEData()
	{
	...
	try
		...
		List<PensionApplicationForm1AverageEmolumentsValDao> aeli=penappmHeadOfficeform1calcservice.loadHOForm1FieldOfficeOldAe(empId);
		
		for(PensionApplicationForm1AverageEmolumentsValDao aetmp:aeli)
		{
			aexmlString.append("<aerecord>");
			aexmlString.append("<avgid>"+aetmp.getAvgID()+"</avgid>");
			aexmlString.append("<nc>"+aetmp.getMaxcheck_value()+"</nc>");
	...
	public String loadPenAppHOForm1FieldOfficeOldRecoveryData()
	{
	...
	try
		...
		List<PensionApplicationForm1RecoveriesValDao> recli=penappmHeadOfficeform1calcservice.loadHOForm1FieldOfficeOldRecoveries(empId);
		
		for(PensionApplicationForm1RecoveriesValDao rectmp:recli)
		{
			recxmlString.append("<recrecord>");
			recxmlString.append("<recid>"+rectmp.getRecID()+"</recid>");
			recxmlString.append("<recdescription>"+rectmp.getRec_description()+"</recdescription>");
	...
	public String loadPenAppHOForm1ComData()
	{
		...
		try
		{
			PrintWriter out = getResponse().getWriter();	
			HttpSession session=getRequest().getSession();
			int age=pensionAppCalcHOForm1.getAge();
			
			
			Double commvalue=penappmHeadOfficeform1calcservice.penAppHOForm1CalcComSettingData(age);
	...
	public String loadPenAppHOForm1EmpStatus()
	{
		...
		try
		{
			PrintWriter out = getResponse().getWriter();	
			HttpSession session=getRequest().getSession();
			int empId=pensionAppCalcHOForm1.getEmpNo();
			
			myempstatusList=penappmHeadOfficeform1calcservice.penAppHOForm1CalcEmpStatusData(empId);
			...
			for(Object[] empstatetl: myempstatusList)
			{
			 ...
			 getResponse().setContentType("text/xml");
			 System.out.println("2,employee_status------->"+xmlString);
			 out.println(xmlString.toString());
			 out.flush();
			 out.close();			
	...
	public String addPensionAppHOForm1Calculation()
	{
		...
		{ 		
			...
			Date deatdate=pensionAppCalcHOForm1.getDeath_date1();			
			
			Integer level=pensionAppCalcHOForm1.getLastlevel();
			...
			if(basic_pay != null){
				...
				penappmHeadOfficeform1calcservice.deleteHOForm1Avgemoluments(pensionAppCalcHOForm1.getEmpNo());
				PensionApplicationHOForm1AverageEmolumentsDao form1aemultidata=null;
				ho_form1aemultidatlist = new ArrayList<PensionApplicationHOForm1AverageEmolumentsDao>();
			    
			    for(int i=0; i<basic_pay.size(); i++)
			    {
			    	form1aemultidata = new PensionApplicationHOForm1AverageEmolumentsDao();	    	
			    	...
			    	form1aemultidata.setEmpNo(pensionAppCalcHOForm1.getEmpNo());
			    	...
			    	ho_form1aemultidatlist.add(form1aemultidata);
			    }
			    			   
			    penappmHeadOfficeform1calcservice.saveAddHOAverageEmoluments(ho_form1aemultidatlist);
			}
			
			}
			
			
			PensionApplicationHOForm1OthDeptServiceDao hoform1othdpetservicedao=null;
			penappmHeadOfficeform1calcservice.deleteHOForm1Othdeptservice(pensionAppCalcHOForm1.getEmpNo());
			ho_form1othdeptservicelist=new ArrayList<PensionApplicationHOForm1OthDeptServiceDao>();
			if(pensionAppCalcHOForm1.getOtherdeparmentserviceFlag().equals("Yes"))
			{
				
				PensionApplicationHOForm1OthDeptServiceDaoPK compositePk = null;
				
				for(int i=0;i<othdeptfromdate.length;i++)
				{
					hoform1othdpetservicedao=new PensionApplicationHOForm1OthDeptServiceDao();
					compositePk = new PensionApplicationHOForm1OthDeptServiceDaoPK();
				    compositePk.setEmpNo(pensionAppCalcHOForm1.getEmpNo());
					compositePk.setFromdate(othdeptfromdate[i]);
					hoform1othdpetservicedao.setCompositePK(compositePk);
					hoform1othdpetservicedao.setTodate(othdepttodate[i]);
					hoform1othdpetservicedao.setOthServiceYear(otdepyear[i]);
					hoform1othdpetservicedao.setOthServiceMonth(otdepmonth[i]);
					hoform1othdpetservicedao.setOtherServiceDay(othdeptday[i]);
					hoform1othdpetservicedao.setDepartmentName(Departmentname[i]);
					hoform1othdpetservicedao.setRemarks(Remarks[i]);
					hoform1othdpetservicedao.setUpdatedUser(updatedId);
					hoform1othdpetservicedao.setUpdateDate(new java.sql.Timestamp(new java.util.Date().getTime()));
					hoform1othdpetservicedao.setUnlockedBy(updatedId);
					hoform1othdpetservicedao.setUnlockedDate(new java.sql.Timestamp(new java.util.Date().getTime()));
					
					ho_form1othdeptservicelist.add(hoform1othdpetservicedao);
					
					System.out.println("The length size--------------------"+othdeptfromdate[i]);
				}
				
				penappmHeadOfficeform1calcservice.saveAddHOOtherDepartmentService(ho_form1othdeptservicelist);
			//	penappmHeadOfficeform1calcservice.saveAddHOOtherDepartmentService(ho_form1othdeptservicelist);
				pensionAppCalcHOForm1.getTototdepyear();
				pensionAppCalcHOForm1.getTototdepmonth();
				pensionAppCalcHOForm1.getTotothdeptday();
				...
				if(rec_amount != null){	
					...
					penappmHeadOfficeform1calcservice.deleteHOForm1Recoveries(pensionAppCalcHOForm1.getEmpNo());
				    ...
				    penappmHeadOfficeform1calcservice.saveHOForm1Recoveries(ho_form1recmultidatlist);
			}
			
				
				age=pensionAppCalcHOForm1.getAge();
				
				Integer commutedamount=pensionAppCalcHOForm1.getCommutedamount();
				float commfloatval=Float.parseFloat(penappmHeadOfficeform1calcservice.penAppHOForm1CalcComSettingData(age)+"");	
				pensionAppCalcHOForm1.setCommuted_val(commfloatval);
				...
				pensionAppCalcHOForm1.setTotcommutedamount(commutedpenamount);		
				//pensionAppCalcHOForm1.setCommuted_val(45);
				...
				Date vrsdate=pensionAppCalcHOForm1.getVrs_date1();
				Date retiredate=pensionAppCalcHOForm1.getDar1();
				Date dedate=pensionAppCalcHOForm1.getDeath_date1();
				String dor="";
				if(vrsdate!=null)
				{
					DateFormat formatter= new SimpleDateFormat("dd/MM/yyyy");
				...
				int dapercentage=penappmHeadOfficeform1calcservice.penAppHOForm1CalcdaSettingData(dor);				
				
				pensionAppCalcHOForm1.setDa_percentage(dapercentage);
				
				  String basic_include=pensionAppCalcHOForm1.getAvg_include_basic();
				  String basic_da=pensionAppCalcHOForm1.getAvg_da_basic();
				  			  
				  String grade_include=pensionAppCalcHOForm1.getAvg_include_grade();
				  String grade_da=pensionAppCalcHOForm1.getAvg_da_grade();
				 			  
				  String special_include=pensionAppCalcHOForm1.getAvg_include_special();
				  String special_da=pensionAppCalcHOForm1.getAvg_da_special();
				  
				  String other1_include=pensionAppCalcHOForm1.getAvg_include_other1();
				  String other1_da=pensionAppCalcHOForm1.getAvg_da_other1();
				  
				  String other2_include=pensionAppCalcHOForm1.getAvg_include_other2();
				  String other2_da=pensionAppCalcHOForm1.getAvg_da_other2();
				  
				  String other3_include=pensionAppCalcHOForm1.getAvg_include_other3();
				  String other3_da=pensionAppCalcHOForm1.getAvg_da_other3();
				  ...
				  finaltotalppamount=pensionAppCalcHOForm1.getFinaltotppamount();
				  if(pensionAppCalcHOForm1.getLastbasic()==null)
				  {
					  lastbasic=0;
				  }
				  else
				  {
				  lastbasic=pensionAppCalcHOForm1.getLastbasic();
				  }
				  if(pensionAppCalcHOForm1.getLastgrade()==null)
				  {
					  lastgrade=0;
				  }
				  else
				  {
					  lastgrade=pensionAppCalcHOForm1.getLastgrade();
				  }
				  if(pensionAppCalcHOForm1.getLastspecial()==null)
				  {
					  lastspecial=0;
				  }
				  else
				  {
					  lastspecial=pensionAppCalcHOForm1.getLastspecial();
				  }
				  if(pensionAppCalcHOForm1.getLastother1()==null)
				  {
					  lastother1=0;
				  }
				  else
				  {
					  lastother1=pensionAppCalcHOForm1.getLastother1();
				  }
				  if(pensionAppCalcHOForm1.getLastother2()==null)
				  {
					  lastother2=0;
				  }
				  else
				  {
					  lastother2=pensionAppCalcHOForm1.getLastother2();
				  }
				  if(pensionAppCalcHOForm1.getLastother3()==null)
				  {
					  lastother3=0;
				  }
				  else
				  {
					  lastother3=pensionAppCalcHOForm1.getLastother3();
				  }
				...
				//  lasttotal=lastbasic+lastgrade+lastspecial+lastother1+lastother2+lastother3;
				  ...
				  maxdcrgamount=pensionAppCalcHOForm1.getMax_dcrg_amt();
				  dcrghalfyear=pensionAppCalcHOForm1.getNohalfyeardcrg();
				  ...
				  System.out.println("DECRG OEN AMOUNT 1::::::"+dcrgpensionamuont);
				  System.out.println("DA OEN AMOUNT 1::::::"+damount);
				  
				  System.out.println("nqs_year==== "+pensionAppCalcHOForm1.getNqs_year());
						  //pensionAppCalcHOForm1.getNqs_year());
				  System.out.println("nqs_month==== "+pensionAppCalcHOForm1.getNqs_month());
				  System.out.println("nqs_day==== "+pensionAppCalcHOForm1.getNqs_day());
				  
				  if(!(pensionAppCalcHOForm1.getDeath_date1()+"").equalsIgnoreCase("null"))
				  {
						Integer nqs_year=0;
						Integer multvar_dcrg=1;
						float lpd=lasttotal;
						if(!(pensionAppCalcHOForm1.getNqs_year()+"").equalsIgnoreCase("null"))
						{
							  nqs_year=pensionAppCalcHOForm1.getNqs_year();
							  System.out.println("nqs_year--------------"+nqs_year);
						}
						if(nqs_year<1)
						{
							multvar_dcrg=2;
				  ...
				  if((dcrgpensionamuont>=maxdcrgamountcheck))
				  {
					...
					pensionAppCalcHOForm1.setDamount((int)Math.round(damount));				
					pensionAppCalcHOForm1.setDcrgamount((int)Math.round(dcrgpensionamuont));
									
					pensionAppCalcHOForm1.setProcessStatus("ENTERED");
					pensionAppCalcHOForm1.setUpdatedUser(updatedId);
					pensionAppCalcHOForm1.setUpdateDate(new java.sql.Timestamp(new java.util.Date().getTime()));
					pensionAppCalcHOForm1.setUnlockedBy(updatedId);
					pensionAppCalcHOForm1.setUnlockedDate(new java.sql.Timestamp(new java.util.Date().getTime()));
					pensionAppCalcHOForm1.setScaleOfPay(getScaleOfPay());
					System.out.println("SCALE OF PAY FOR ACTION:::"+getScaleOfPay());
					//System.out.println("SCALE OF PAY:::"+pensionAppCalcHOForm1.getScaleOfPay());
					penappmHeadOfficeform1calcservice.savePensionAppHOForm1Calculation(pensionAppCalcHOForm1);	
		
				reportEmpId=pensionAppCalcHOForm1.getEmpNo();
				Date deathdate=pensionAppCalcHOForm1.getDeath_date1();
				Date vdate=pensionAppCalcHOForm1.getVrs_date1();
				Date retdate=pensionAppCalcHOForm1.getDar1();
	...
	public PensionApplicationHOForm1CalcMstDataService getPenappmHeadOfficeform1calcservice() {
		return penappmHeadOfficeform1calcservice;
	}
	public void setPenappmHeadOfficeform1calcservice(
			PensionApplicationHOForm1CalcMstDataService penappmHeadOfficeform1calcservice) {
		this.penappmHeadOfficeform1calcservice = penappmHeadOfficeform1calcservice;
	}	
	public PensionApplicationHOForm1Dao getPensionAppCalcHOForm1() {
		return pensionAppCalcHOForm1;
	}
	public void setPensionAppCalcHOForm1(
			PensionApplicationHOForm1Dao pensionAppCalcHOForm1) {
		this.pensionAppCalcHOForm1 = pensionAppCalcHOForm1;
	}
	public List<PensionApplicationHOForm1AverageEmolumentsDao> getHo_form1aemultidatlist() {
		return ho_form1aemultidatlist;
	}
	public void setHo_form1aemultidatlist(
			List<PensionApplicationHOForm1AverageEmolumentsDao> ho_form1aemultidatlist) {
		this.ho_form1aemultidatlist = ho_form1aemultidatlist;
	}
	public List<PensionApplicationHOForm1RecoveriesDao> getHo_form1recmultidatlist() {
		return ho_form1recmultidatlist;
	}

	public void setHo_form1recmultidatlist(
			List<PensionApplicationHOForm1RecoveriesDao> ho_form1recmultidatlist) {
		this.ho_form1recmultidatlist = ho_form1recmultidatlist;
	}
  ...
  public List<PensionApplicationHOForm1OthDeptServiceDao> getHo_form1othdeptservicelist() {
	return ho_form1othdeptservicelist;
}
public void setHo_form1othdeptservicelist(
		List<PensionApplicationHOForm1OthDeptServiceDao> ho_form1othdeptservicelist) {
	this.ho_form1othdeptservicelist = ho_form1othdeptservicelist;
}
