...
public class ValidateCutOfEntryAction extends BaseAction  {

	/**
	 * 
	 */
	private static final long serialVersionUID = 8448779501944144751L;
	...
	public void load(int officeId){
			...
			stateload = stateservice.getListOfstates();
			desigload = desiservice.getListOfDesig(searchVPpoNo);
			branchload = branchservice.getBranchList(searchVPpoNo,officeId);
	...
	public String validateCutOfPension(){
		
		try{
			int ppoNo=searchVPpoNo;
			//System.out.println("----------------------------------->inside edit ready to start further works");
			...
			editAddNominee(mstcutoff.getPpoNo());	
	...
	public int getSearchVPpoNo() {
		return searchVPpoNo;
	}

	public void setSearchVPpoNo(int searchVPpoNo) {
		this.searchVPpoNo = searchVPpoNo;
	}
