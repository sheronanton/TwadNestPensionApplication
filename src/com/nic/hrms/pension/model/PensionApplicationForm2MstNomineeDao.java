...
public class PensionApplicationForm2MstNomineeDao implements Serializable{

	
	/**
	 * 
	 */
	private static final long serialVersionUID = -3052803989430197299L;
	...
	public void setNominReason(String nominReason) {
		this.nominReason = nominReason;
	}
	public String getNominReason() {
		return nominReason;
	}
