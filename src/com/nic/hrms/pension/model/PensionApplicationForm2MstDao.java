...
public class PensionApplicationForm2MstDao implements Serializable {

	
	/**
	 * 
	 */
	private static final long serialVersionUID = 4212598416400311714L;
	...
	public void setAppliedDate(String appliedDate) {
		if(appliedDate.trim() != null && appliedDate.trim().length() >0)
		{
			try
			{	            
	            DateFormat appdate1 = new SimpleDateFormat("dd/MM/yyyy");	            
	            setAppliedDate1(appdate1.parse(appliedDate));
	        }
			catch(Exception e)
			{
	            e.printStackTrace();
	...
	public void setAppliedDate1(Date appliedDate1) {
		...
		if(appliedDate1 != null)
		{
			try {
		         	...
		         	String appdate = formatter.format(appliedDate1);
		         	setAppliedDate2(appdate);
		        }
			catch (Exception e)
		    {
				e.printStackTrace();
