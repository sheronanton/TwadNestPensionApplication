...
public class PensionApplicationForm1ValDao implements Serializable {
	...
	private Integer level_of_pay;
	
	
	
	public Integer getLevel_of_pay() {
		return level_of_pay;
	}
	public void setLevel_of_pay(Integer level_of_pay) {
		this.level_of_pay = level_of_pay;
	}
	...
	String avg_include_basic;
	 ...
	 private Integer tototdepyear;
	 private Integer tototdepmonth;
	 private Integer totothdeptday;
	...
	public Integer getTototdepyear() {
		return tototdepyear;
	}
	public void setTototdepyear(Integer tototdepyear) {
		this.tototdepyear = tototdepyear;
	}
	public Integer getTototdepmonth() {
		return tototdepmonth;
	}
	public void setTototdepmonth(Integer tototdepmonth) {
		this.tototdepmonth = tototdepmonth;
	}
	public Integer getTotothdeptday() {
		return totothdeptday;
	}
	public void setTotothdeptday(Integer totothdeptday) {
		this.totothdeptday = totothdeptday;
	}
