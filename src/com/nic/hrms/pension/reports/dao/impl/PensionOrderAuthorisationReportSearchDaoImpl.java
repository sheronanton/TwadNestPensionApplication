...
public class PensionOrderAuthorisationReportSearchDaoImpl implements PensionOrderAuthorisationReportSearchService {
			...
			try
			{
				...
				/* String str="SELECT emp.employee_id," +
				 ...
				 String str="SELECT emp.employee_id," +
			 		...
			 		"LEFT OUTER JOIN HRM_PEN_APP_HO_MST_FORM1_DET app ON app.emp_id = emp.employee_id " +
			 		"LEFT OUTER JOIN HRM_PEN_APP_HO_MST_FORM2_DET appform2 ON app.emp_id = appform2.EMP_NO " +
			 		"WHERE (lower(CAST(emp.employee_id AS TEXT)) LIKE '%"+penappreportSearchKeyword+"%')";
			...
			try
			{
				...
				/* String str="SELECT emp.employee_id," +
				 ...
				 String str="SELECT emp.employee_id," +
			 		...
			 		"LEFT OUTER JOIN HRM_PEN_APP_HO_MST_FORM1_DET app ON app.emp_id = emp.employee_id " +
			 		"LEFT OUTER JOIN HRM_PEN_APP_HO_MST_FORM2_DET appform2 ON app.emp_id = appform2.EMP_NO " +			 		
			 		"WHERE (lower(CAST(emp.employee_name AS TEXT)) LIKE '%"+penappreportSearchKeyword+"%')";
