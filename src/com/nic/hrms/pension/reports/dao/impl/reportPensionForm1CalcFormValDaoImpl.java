...
public class reportPensionForm1CalcFormValDaoImpl implements reportPensionForm1CalcFormValService{

	private SessionFactory sessionFactory;

	@SuppressWarnings({ "unchecked", "deprecation" })
	public List<pensionForm1CalcValDetailsDao> getForm1AvgValDetails(HttpServletRequest request, int empId) {
		...
		String objstring="";
		 ...
		 averageemolamount=sumofav/aetotmonth;
				...
				for(Object[] tmp:li)
				{
					...
					/*String subjectcontent1="";
					String subjectcontent2="";
					String subjectcontent3="";
					String subjectcontent4="";*/
					
					/*subjectcontent2="Subject to approval necessary authorisation is put up below for approval with the following remarks";
					pd.setSUBJECT_CONTENT2(subjectcontent2);
					subjectcontent1="1. ";
					pd.setSUBJECT_CONTENT1(subjectcontent1);
					subjectcontent3="2. LPC to be furnished";
					pd.setSUBJECT_CONTENT3(subjectcontent3);
					subjectcontent4="3. Copy of Retirement order to be furnished";
					pd.setSUBJECT_CONTENT4(subjectcontent4);*/
	...
	public List<pensionForm1CalcValDetailsDao> getForm1OtherDeptServiceVal(HttpServletRequest request, int empId)
	{
		...
		try
		   {
				...
				String sqlQry="SELECT " +
						...
						"TOT_DAY_SERVICE," +
						"DEPATMENT_NAME," +
						"REMARKS FROM HRM_PEN_APP_MST_OTHDEPTSER_VAL where  EMPLOYEEID ="+empId;
	...
	@SuppressWarnings({ "deprecation", "unchecked" })
	public List<pensionForm1CalcValDetailsDao> getPensionForm1CalcValDetails(HttpServletRequest request, int empId) {
		...
		for(Object[] avgsettingtmp:avgsettingmainli)
		{
			...
			if((avgsettingtmp[0]+"").equals("OTHER PAY3"))
			{
				...
				String sqlQry="select " +
						...
						"OTH_DEPT_TOT_DAYS ,   " +
						"LEVEL_OF_PAY   " +
						"from HRM_PEN_APP_MST_FORM1_DET cd where cd.EMP_ID="+empId;				
				...
				for(Object[] tmp:mainli)
				{
					...
					mainpd.setLEVEL_OF_PAY((BigDecimal)tmp[90]);
					...
					if(tmp[86]!=null)
					{
							if((tmp[86]+"").equals("Yes"))
							{
								if((tmp[87]+"").equals("null") || (tmp[87])==null)
								{
									othdeptyear=0;
								...
								{
									othdeptyear	=Integer.parseInt(tmp[87]+"");
								...
								{
									othdeptmonth	=Integer.parseInt(tmp[88]+"");
								...
								{
									othdeptday	=Integer.parseInt(tmp[89]+"");
			        ...
			        String subject_content="Service verification upto "+dadate+" to be furnished";
	...
	@SuppressWarnings({ "deprecation", "unchecked" })
	public List<pensionForm1CalcValDetailsDao> getForm1RecoveryValDetails(HttpServletRequest request, int empId) {
	...
	@SuppressWarnings({ "deprecation", "unchecked" })
	public List<pensionForm1CalcValDetailsDeathDao> getPensionForm1CalcDeathValDetails(HttpServletRequest request, int empId) {
		...
		for(Object[] avgsettingtmp:avgsettingmainli)
		{
					...
					if(tmp[87]!=null)
			{
					...
					{
						if((tmp[88]+"").equals("null") || (tmp[87])==null)
						{
							othdeptyear=0;
					...
					try
					{
						...
						String objstring="";
						 ...
						 String sqlQryforsumofrec="select rec.REC_AMOUNT,rec.REC_DESC from HRM_PEN_APP_MST_RECO_FORM1 rec where rec.EMP_ID="+empId;		
							...
							System.out.println("lastpaydrwan"+lastpaydrwan);
