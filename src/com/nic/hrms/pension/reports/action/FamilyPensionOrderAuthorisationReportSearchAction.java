...
public class FamilyPensionOrderAuthorisationReportSearchAction extends BaseAction {

	
	private static final long serialVersionUID = 4738479838165595678L;
	private FamilyPensionOrderAuthorisationReportSearchService familyPenOrderAuthorisationreportservice;
    ...
    int	empId;
		...
		try{
			...
			penOrderReplist=familyPenOrderAuthorisationreportservice.penOrderAuthorisationReportUserSearch(empId);
		...
		public String PenOrderAuthorisationReportUserSrch1(){
			...
			try{
				...
				penOrderReplist=familyPenOrderAuthorisationreportservice.penOrderAuthorisationReportUserSearch1(penorderReportSearchOptions, penorderReportSearchKeyword, empId);
	...
	public FamilyPensionOrderAuthorisationReportSearchService getFamilyPenOrderAuthorisationreportservice() {
			return familyPenOrderAuthorisationreportservice;
		}
		public void setFamilyPenOrderAuthorisationreportservice(
				FamilyPensionOrderAuthorisationReportSearchService familyPenOrderAuthorisationreportservice) {
			this.familyPenOrderAuthorisationreportservice = familyPenOrderAuthorisationreportservice;
		}
