...
import com.nic.hrms.pension.reports.service.reportRevisedPensionCalcService;


public class reportRevisedPensionCalcAction extends BaseAction{
	...
	private reportRevisedPensionCalcService reportRevisedPensionCalcService;
	...
	public String revised_pension_report_print() throws JRException
	{
		...
		pensionHOForm1CalcDetails=reportRevisedPensionCalcService.getRevisedPensionCalcDetails(getRequest(),empId);		
		form1avgDetails=reportRevisedPensionCalcService.getRevisedChangeAvgDetails(getRequest(),empId);
		form1recovery=reportRevisedPensionCalcService.getHOForm1RecoveryDetails(getRequest(),empId);		
		form1otherdeptservice=reportRevisedPensionCalcService.getHOForm1OtherDeptService(getRequest(),empId);
				    
		System.out.println("otherdept====="+form1otherdeptservice.size());
		
			reportParams.put("dir",getRequest().getRealPath("/org/HR/hr/pension/reports/Average_Emoulment_Form1.jasper"));			
			//reportParams.put("dir2",getRequest().getRealPath("/org/HR/hr/pension/reports/form1otherdeptservices_rev.jasper"));
	...
	public String revised_pension_report_deathprint() throws JRException
	{
		...
		pensionHOForm1CalcDeathDetails=reportRevisedPensionCalcService.getRevisedPensionCalcDeathDetails(getRequest(),empId);		
		form1recovery=reportRevisedPensionCalcService.getHOForm1RecoveryDetails(getRequest(),empId);
	...
	public reportRevisedPensionCalcService getReportRevisedPensionCalcService() {
		return reportRevisedPensionCalcService;
	}
	public void setReportRevisedPensionCalcService(
			reportRevisedPensionCalcService reportRevisedPensionCalcService) {
		this.reportRevisedPensionCalcService = reportRevisedPensionCalcService;
	}
